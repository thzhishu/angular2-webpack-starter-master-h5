...
export interface Preference {
    /**
     * \"fontSize\":\"字体大小\",  \"welcomePage\":\"欢迎页内容\",  \"endPage\":\"结束页内容\" ipLimit 相同IP限制答题人数,默认0关闭>0开启  mobileCheck 是否开启LBS验证,,默认0不开启1开启 mobileCheck 是否开启手机验证,,默认0不开启1开启 theme:  主题                    
     */
    key?: Preference.KeyEnum;
...
export namespace Preference {
    export enum KeyEnum {
        ...
        IpLimit = <any> 'ipLimit',
        LbsCheck = <any> 'lbsCheck',
        MobileCheck = <any> 'mobileCheck',
        Theme = <any> 'theme'
    }
}
