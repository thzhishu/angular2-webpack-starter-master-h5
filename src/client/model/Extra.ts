...
export interface Extra {
    ...
    /**
     * 扩展设置， 提供额外信息， 服务端不关注业务用途， 前端可以自定义key值 这里对应\"子问题设置\"的 \"形式/表头\", \"占位\", \"表格风格=AQ/QA\"等                  
     */
    key?: Extra.KeyEnum;
...
export namespace Extra {
    export enum KeyEnum {
        ...
        Ocuppy = <any> 'ocuppy',
        TableStyle = <any> 'tableStyle',
        FirstColumnWidth = <any> 'firstColumnWidth',
        Fade = <any> 'fade',
        Movedown = <any> 'movedown',
        ColumnStyle = <any> 'columnStyle',
        RowSwitch = <any> 'rowSwitch'
    }
}
