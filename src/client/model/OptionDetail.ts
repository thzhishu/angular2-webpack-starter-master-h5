...
export interface OptionDetail {
    ...
    /**
     * 如果是开放题， 可以指定数据类型, \"none\" 无, \"default\" 普通, \"number\" 数字, \"integer\" 整数, \"email\" 电子邮件, \"phone\" 电话, \"alphabit\" 字母, \"expression\" 自定义(正则表达式) 
     */
    dataType?: OptionDetail.DataTypeEnum;
    ...
    /**
     * 额外信息,服务端原样保存数据。 可以用在\"矩阵题的子问题设置\", \"颜色题的颜色设置\", \"每行评分题的效果和分制\"
     */
    extra?: Array<models.Extra>;

}
export namespace OptionDetail {
