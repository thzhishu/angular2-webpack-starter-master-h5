...
export class SearchApi {
  ...
  /**
   * 自动补全接口， 客户端设置timeout， 如果3秒内都没有内容，就自动关闭自动补全功能
   *
   * @param key 搜索的关键字
   * @param type 类型, &#39;default&#39;车牌、手机号, &#39;brand&#39;问卷里的品牌， &#39;model&#39;问卷里模型
   */
  public searchAutocompleteGet(key: string, type: string, extraHttpRequestParams?: any): Observable<models.WordResponse> {
    const path = this.basePath + '/search/autocomplete';
    ...
    if (key === null || key === undefined) {
      throw new Error('Required parameter key was null or undefined when calling searchAutocompleteGet.');
    }
    // verify required parameter 'type' is not null or undefined
    if (type === null || type === undefined) {
      throw new Error('Required parameter type was null or undefined when calling searchAutocompleteGet.');
    }
    if (key !== undefined) {
      queryParameters.set('key', key);
    }
